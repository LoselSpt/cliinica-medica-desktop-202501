...
public class EspecialidadeAddForm extends BaseScreen {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger
            .getLogger(EspecialidadeAddForm.class.getName());
    ...
    private void salvarBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_salvarBtnActionPerformed
        try {
            ...
            if (status == true) {
                JOptionPane.showMessageDialog(this, "Especialidade cadastrada com sucesso!", "Status da operação",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Erro ao cadastrar Especialidade - contate o administrador!",
